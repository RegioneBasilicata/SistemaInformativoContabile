...
public class ListaContiBancariTypesImpl implements it.latraccia.entity.anasic.risposta.ListaContiBancariTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.anasic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.anasic.risposta.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _ContoBancario;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.anasic.risposta.ListaContiBancariTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getContoBancario() {
        if (_ContoBancario == null) {
            _ContoBancario = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _ContoBancario;
    }

    public java.util.List getContoBancario() {
        return _getContoBancario();
    }
    ...
    public it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.anasic.risposta.impl.ListaContiBancariTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_ContoBancario == null)? 0 :_ContoBancario.size());
        while (idx1 != len1) {
            context.startElement("", "ContoBancario");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ContoBancario.get(idx_0 ++)), "ContoBancario");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ContoBancario.get(idx_1 ++)), "ContoBancario");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ContoBancario.get(idx1 ++)), "ContoBancario");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u00004it.latraccia.entity.anasic.risposta.DatiBancari"
...
+"LSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\rContoBancariot\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.s"
...
+"\u0006\u0001pq\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\u0013q\u0000~\u0000\u0010q\u0000~\u0000\bx"));
        ...
        extends it.latraccia.entity.anasic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.anasic.risposta.impl.ListaContiBancariTypesImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("IdContoCorrente" == ___local)&&("" == ___uri)) {
                            _getContoBancario().add(((it.latraccia.entity.anasic.risposta.impl.DatiBancariTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.anasic.risposta.impl.DatiBancariTypesImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                }
