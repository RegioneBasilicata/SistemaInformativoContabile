...
public class RispostaInterrogaComuniTypesImpl implements it.latraccia.entity.anasic.risposta.RispostaInterrogaComuniTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.anasic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.anasic.risposta.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Comune;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.anasic.risposta.RispostaInterrogaComuniTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getComune() {
        if (_Comune == null) {
            _Comune = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Comune;
    }
    ...
    public it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.anasic.risposta.impl.RispostaInterrogaComuniTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Comune == null)? 0 :_Comune.size());
        while (idx1 != len1) {
            context.startElement("", "Comune");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Comune.get(idx_0 ++)), "Comune");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Comune.get(idx_1 ++)), "Comune");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Comune.get(idx1 ++)), "Comune");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000/it.latraccia.entity.anasic.risposta.ComuneTypes"
...
+"ma-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0006Comunet\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.gramm"
...
+"#q\u0000~\u0000\u0005q\u0000~\u0000\u0013q\u0000~\u0000\u0010q\u0000~\u0000\bx"));
        ...
        extends it.latraccia.entity.anasic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.anasic.risposta.impl.RispostaInterrogaComuniTypesImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("IdComune" == ___local)&&("" == ___uri)) {
                            _getComune().add(((it.latraccia.entity.anasic.risposta.impl.ComuneTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.anasic.risposta.impl.ComuneTypesImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
