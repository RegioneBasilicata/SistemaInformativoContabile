...
public class RispostaInterrogaAnagraficaTypesImpl implements it.latraccia.entity.anasic.risposta.RispostaInterrogaAnagraficaTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.anasic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.anasic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.anasic.risposta.RispostaInterrogaAnagraficaTypes.class);
    }
    ...
    public it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.anasic.risposta.impl.RispostaInterrogaAnagraficaTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Anagrafica == null)? 0 :_Anagrafica.size());
        while (idx1 != len1) {
            context.startElement("", "Anagrafica");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Anagrafica.get(idx_0 ++)), "Anagrafica");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Anagrafica.get(idx_1 ++)), "Anagrafica");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Anagrafica.get(idx1 ++)), "Anagrafica");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u00003it.latraccia.entity.anasic.risposta.AnagraficaT"
...
+"\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\u0013q\u0000~\u0000\u0010q\u0000~\u0000\bx"));
        ...
        extends it.latraccia.entity.anasic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.anasic.risposta.impl.RispostaInterrogaAnagraficaTypesImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("IdAnagrafica" == ___local)&&("" == ___uri)) {
                            _getAnagrafica().add(((it.latraccia.entity.anasic.risposta.impl.AnagraficaTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.anasic.risposta.impl.AnagraficaTypesImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
