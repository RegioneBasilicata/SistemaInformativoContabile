...
public class MessaggioRispostaMassivaTypesImpl implements it.latraccia.entity.anasic.risposta.MessaggioRispostaMassivaTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.anasic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.anasic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.anasic.risposta.MessaggioRispostaMassivaTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getRispostaMassivaType() {
        if (_RispostaMassivaType == null) {
            _RispostaMassivaType = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _RispostaMassivaType;
    }

    public java.util.List getRispostaMassivaType() {
        return _getRispostaMassivaType();
    }
    ...
    public it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.anasic.risposta.impl.MessaggioRispostaMassivaTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_RispostaMassivaType == null)? 0 :_RispostaMassivaType.size());
        while (idx1 != len1) {
            context.startElement("", "RispostaMassiva_Type");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _RispostaMassivaType.get(idx_0 ++)), "RispostaMassivaType");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _RispostaMassivaType.get(idx_1 ++)), "RispostaMassivaType");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _RispostaMassivaType.get(idx1 ++)), "RispostaMassivaType");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000Yit.latraccia.entity.anasic.risposta.MessaggioRi"
+"spostaMassivaTypes.RispostaMassivaTypeTypet\u0000+http://java.sun"
...
+"\u0000~\u0000\u001et\u0000\u0014RispostaMassiva_Typet\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.E"
...
+"\u0000\u0005q\u0000~\u0000\u0013q\u0000~\u0000\u0010q\u0000~\u0000\bx"));
    ...
    public static class RispostaMassivaTypeTypeImpl implements it.latraccia.entity.anasic.risposta.MessaggioRispostaMassivaTypes.RispostaMassivaTypeType, com.sun.xml.bind.JAXBObject, it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.anasic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.anasic.risposta.impl.runtime.ValidatableObject
    {

        protected it.latraccia.entity.anasic.risposta.RispostaProcessaAnagraficaTypes _RispostaProcessaAnagrafica;
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (it.latraccia.entity.anasic.risposta.MessaggioRispostaMassivaTypes.RispostaMassivaTypeType.class);
        }

        public it.latraccia.entity.anasic.risposta.RispostaProcessaAnagraficaTypes getRispostaProcessaAnagrafica() {
            return _RispostaProcessaAnagrafica;
        }

        public void setRispostaProcessaAnagrafica(it.latraccia.entity.anasic.risposta.RispostaProcessaAnagraficaTypes value) {
            _RispostaProcessaAnagrafica = value;
        }
        ...
        public it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.anasic.risposta.impl.runtime.UnmarshallingContext context) {
            return new it.latraccia.entity.anasic.risposta.impl.MessaggioRispostaMassivaTypesImpl.RispostaMassivaTypeTypeImpl.Unmarshaller(context);
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            context.endElement();
            if ((_Eccezione == null)&&(_RispostaProcessaAnagrafica!= null)) {
                context.startElement("", "Risposta_ProcessaAnagrafica");
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _RispostaProcessaAnagrafica), "RispostaProcessaAnagrafica");
                context.endNamespaceDecls();
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _RispostaProcessaAnagrafica), "RispostaProcessaAnagrafica");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _RispostaProcessaAnagrafica), "RispostaProcessaAnagrafica");
                context.endElement();
            } else {
                if ((_Eccezione!= null)&&(_RispostaProcessaAnagrafica == null)) {
...
+"IdAnagraficaMittentet\u0000\u0000sq\u0000~\u0000!ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006pp\u0000sq\u0000"
...
+"sion\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00003q\u0000~\u0000Asr\u0000 com.sun.msv.grammar.AnyNa"
+"meClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000-q\u0000~\u00002sq\u0000~\u0000,t\u0000Cit.latraccia.entity.an"
+"asic.risposta.RispostaProcessaAnagraficaTypest\u0000+http://java."
+"sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000!ppsq\u0000~\u0000#q\u0000~\u0000\u0010pq\u0000~\u0000%q\u0000~\u0000"
+".q\u0000~\u00002sq\u0000~\u0000,t\u0000\u001bRisposta_ProcessaAnagraficaq\u0000~\u00006sq\u0000~\u0000\u0006pp\u0000sq\u0000~"
+"\u0000\u0000ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000!ppsq\u0000~\u0000<q\u0000~\u0000\u0010psq\u0000~\u0000#q\u0000~\u0000\u0010pq\u0000~\u0000Aq\u0000~\u0000Cq\u0000~\u00002"
+"sq\u0000~\u0000,t\u00002it.latraccia.entity.anasic.risposta.EccezioneTypesq"
+"\u0000~\u0000Fsq\u0000~\u0000!ppsq\u0000~\u0000#q\u0000~\u0000\u0010pq\u0000~\u0000%q\u0000~\u0000.q\u0000~\u00002sq\u0000~\u0000,t\u0000\tEccezioneq\u0000~"
...
+"nPool;xp\u0000\u0000\u0000\f\u0001pq\u0000~\u0000;q\u0000~\u0000Nq\u0000~\u00007q\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000Gq\u0000~\u0000Sq\u0000~\u0000>q\u0000~\u0000Oq"
+"\u0000~\u00009q\u0000~\u0000Lq\u0000~\u0000\nx"));
            }
            return new com.sun.msv.verifier.regexp.REDocumentDeclaration(schemaFragment);
        }
            ...
            extends it.latraccia.entity.anasic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return it.latraccia.entity.anasic.risposta.impl.MessaggioRispostaMassivaTypesImpl.RispostaMassivaTypeTypeImpl.this;
            }
                    ...
                    switch (state) {
                        ...
                        case  4 :
                            if (("Codice" == ___local)&&("" == ___uri)) {
                                _Eccezione = ((it.latraccia.entity.anasic.risposta.impl.EccezioneTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.anasic.risposta.impl.EccezioneTypesImpl.class), 5, ___uri, ___local, ___qname, __atts));
                                return ;
                            }
                            break;
                        case  7 :
                            if (("Operazione" == ___local)&&("" == ___uri)) {
                                _RispostaProcessaAnagrafica = ((it.latraccia.entity.anasic.risposta.impl.RispostaProcessaAnagraficaTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.anasic.risposta.impl.RispostaProcessaAnagraficaTypesImpl.class), 8, ___uri, ___local, ___qname, __atts));
                                return ;
                            }
                            break;
                        case  6 :
                            ...
                            return ;
                        case  3 :
                            if (("Risposta_ProcessaAnagrafica" == ___local)&&("" == ___uri)) {
        ...
        extends it.latraccia.entity.anasic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.anasic.risposta.impl.MessaggioRispostaMassivaTypesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (("IdAnagraficaMittente" == ___local)&&("" == ___uri)) {
                            _getRispostaMassivaType().add(((it.latraccia.entity.anasic.risposta.impl.MessaggioRispostaMassivaTypesImpl.RispostaMassivaTypeTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.anasic.risposta.impl.MessaggioRispostaMassivaTypesImpl.RispostaMassivaTypeTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
