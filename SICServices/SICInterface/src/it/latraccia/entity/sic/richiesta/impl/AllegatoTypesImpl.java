...
public class AllegatoTypesImpl implements it.latraccia.entity.sic.richiesta.AllegatoTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.richiesta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.richiesta.impl.runtime.ValidatableObject
{

    protected java.lang.String _Causale;
    protected java.lang.String _CodiceProgetto;
    protected java.lang.String _CodiceFiscaleBeneficiario;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.richiesta.AllegatoTypes.class);
    }
    ...
    public void setCausale(java.lang.String value) {
        _Causale = value;
    }
    ...
    public void setCodiceProgetto(java.lang.String value) {
        _CodiceProgetto = value;
    }

    public java.lang.String getCodiceFiscaleBeneficiario() {
        return _CodiceFiscaleBeneficiario;
    }

    public void setCodiceFiscaleBeneficiario(java.lang.String value) {
        _CodiceFiscaleBeneficiario = value;
    }
    ...
    public it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.richiesta.impl.AllegatoTypesImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.startElement("", "CodiceProgetto");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _CodiceProgetto), "CodiceProgetto");
        } catch (java.lang.Exception e) {
            it.latraccia.entity.sic.richiesta.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("", "Causale");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _Causale), "Causale");
        } catch (java.lang.Exception e) {
            it.latraccia.entity.sic.richiesta.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        context.endElement();
        context.startElement("", "CodiceFiscaleBeneficiario");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _CodiceFiscaleBeneficiario), "CodiceFiscaleBeneficiario");
        } catch (java.lang.Exception e) {
            it.latraccia.entity.sic.richiesta.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"~\u0000+\u0001q\u0000~\u0000Asq\u0000~\u0000;t\u0000\u000eCodiceProgettoq\u0000~\u0000\u001bsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\r"
+"ppsq\u0000~\u0000\u0011q\u0000~\u0000\u001bpq\u0000~\u0000\u001e\u0000\u0000q\u0000~\u0000\"q\u0000~\u0000\"q\u0000~\u0000%uq\u0000~\u0000&\u0000\u0000\u0000\u0001t\u0000\u000e[0-99999999"
+"99]q\u0000~\u0000*sq\u0000~\u0000-t\u0000\u000estring-derivedq\u0000~\u0000\u001bsq\u0000~\u00000ppsq\u0000~\u00002q\u0000~\u0000,pq\u0000~\u0000"
+"4q\u0000~\u0000=q\u0000~\u0000Asq\u0000~\u0000;t\u0000\u0007Causaleq\u0000~\u0000\u001bsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\rppsr\u0000"
+"#com.sun.msv.datatype.xsd.DoubleType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000+com.sun.m"
+"sv.datatype.xsd.FloatingNumberType\u00fc\u00e3\u00b6\u0087\u008c\u00a8|\u00e0\u0002\u0000\u0000xq\u0000~\u0000 q\u0000~\u0000#t\u0000\u0006d"
+"oubleq\u0000~\u00009q\u0000~\u0000*sq\u0000~\u0000-q\u0000~\u0000Wq\u0000~\u0000#sq\u0000~\u00000ppsq\u0000~\u00002q\u0000~\u0000,pq\u0000~\u00004q\u0000~\u0000"
+"=q\u0000~\u0000Asq\u0000~\u0000;t\u0000\u0007Importoq\u0000~\u0000\u001bsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\rppsq\u0000~\u0000\u0011q\u0000"
+"~\u0000\u001bpq\u0000~\u0000\u001e\u0000\u0001sr\u0000\'com.sun.msv.datatype.xsd.MaxLengthFacet\u0000\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0001\u0002\u0000\u0001I\u0000\tmaxLengthxr\u00009com.sun.msv.datatype.xsd.DataTypeWithVa"
+"lueConstraintFacet\"\u00a7Ro\u00ca\u00c7\u008aT\u0002\u0000\u0000xq\u0000~\u0000\u0014q\u0000~\u0000\u001bpq\u0000~\u0000\u001e\u0000\u0001sr\u0000\'com.sun."
+"msv.datatype.xsd.MinLengthFacet\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001I\u0000\tminLengthxq\u0000~\u0000b"
+"q\u0000~\u0000\u001bpq\u0000~\u0000\u001e\u0000\u0000q\u0000~\u0000\"q\u0000~\u0000\"t\u0000\tminLength\u0000\u0000\u0000\u0010q\u0000~\u0000\"t\u0000\tmaxLength\u0000\u0000\u0000\u0010"
+"q\u0000~\u0000\"q\u0000~\u0000%uq\u0000~\u0000&\u0000\u0000\u0000\u0001t\u0000\u0011([a-zA-Z0-9]){16}q\u0000~\u0000*sq\u0000~\u0000-t\u0000\u000estring"
+"-derivedq\u0000~\u0000\u001bsq\u0000~\u00000ppsq\u0000~\u00002q\u0000~\u0000,pq\u0000~\u00004q\u0000~\u0000=q\u0000~\u0000Asq\u0000~\u0000;t\u0000\u0019Cod"
+"iceFiscaleBeneficiarioq\u0000~\u0000\u001bsr\u0000\"com.sun.msv.grammar.Expressio"
...
+"sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\fq\u0000~\u0000Rq\u0000~\u0000^q\u0000~\u0000\u0007q"
+"\u0000~\u00001q\u0000~\u0000Mq\u0000~\u0000Yq\u0000~\u0000lq\u0000~\u0000\u0005q\u0000~\u0000Fq\u0000~\u0000\u0006x"));
        }
        ...
        extends it.latraccia.entity.sic.richiesta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.richiesta.impl.AllegatoTypesImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        break;
                    case  9 :
                        if (("CodiceFiscaleBeneficiario" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
