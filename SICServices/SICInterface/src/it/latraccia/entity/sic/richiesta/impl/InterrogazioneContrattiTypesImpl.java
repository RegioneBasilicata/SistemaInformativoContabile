...
public class InterrogazioneContrattiTypesImpl implements it.latraccia.entity.sic.richiesta.InterrogazioneContrattiTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.richiesta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.richiesta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.richiesta.InterrogazioneContrattiTypes.class);
    }
    ...
    public java.lang.String getOggettoContratto() {
        return _OggettoContratto;
    }

    public void setOggettoContratto(java.lang.String value) {
    ...
    public it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.richiesta.impl.InterrogazioneContrattiTypesImpl.Unmarshaller(context);
    }

    public void serializeBody(it.latraccia.entity.sic.richiesta.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (_NumeroContratto!= null) {
        ...
        if (_OggettoContratto!= null) {
            context.startElement("", "OggettoContratto");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _OggettoContratto), "OggettoContratto");
            } catch (java.lang.Exception e) {
                it.latraccia.entity.sic.richiesta.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"\f\u0001q\u0000~\u00003sq\u0000~\u0000-t\u0000\u000fNumeroContrattot\u0000\u0000q\u0000~\u00003sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\rp\u0000"
+"sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0012sq\u0000~\u0000\u0006ppsq\u0000~\u0000$q\u0000~\u0000\rpq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u0010Ogg"
+"ettoContrattoq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.grammar.ExpressionPoo"
...
+"q\u0000~\u0000\u0007q\u0000~\u00008x"));
        ...
        extends it.latraccia.entity.sic.richiesta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.richiesta.impl.InterrogazioneContrattiTypesImpl.this;
        }
