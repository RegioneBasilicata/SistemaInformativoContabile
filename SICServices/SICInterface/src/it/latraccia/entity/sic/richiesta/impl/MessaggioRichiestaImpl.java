    ...
    implements it.latraccia.entity.sic.richiesta.MessaggioRichiesta, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.richiesta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.richiesta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.richiesta.MessaggioRichiesta.class);
    }
    ...
    public it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.richiesta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.richiesta.impl.MessaggioRichiestaImpl.Unmarshaller(context);
    }
...
+"q\u0000~\u0000 xq\u0000~\u0000\u001bt\u00003it.latraccia.entity.sic.richiesta.Intestazione"
...
+"aceURIq\u0000~\u0000 xpq\u0000~\u00001q\u0000~\u00000sq\u0000~\u0000\u001ft\u0000\u0004typet\u0000)http://www.w3.org/200"
+"1/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\fIntestazionet\u0000\u0000sq\u0000~\u0000\u0000pp\u0000sq"
+"\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~"
+"\u0000\u001esq\u0000~\u0000\u001ft\u00000it.latraccia.entity.sic.richiesta.RichiestaTypesq"
+"\u0000~\u0000#sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\tRichiestaq\u0000~"
+"\u0000>sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0013Messaggio_Rich"
+"iestaq\u0000~\u0000>sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L"
...
+"xpressionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\u0012q\u0000~\u0000Cq\u0000~\u0000$q\u0000~\u0000\fq\u0000~\u0000Gq\u0000~\u0000@q\u0000~\u0000Kq\u0000~"
+"\u0000\tq\u0000~\u0000\u000fq\u0000~\u0000Bq\u0000~\u0000\nx"));
        }
        ...
        extends it.latraccia.entity.sic.richiesta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.richiesta.impl.MessaggioRichiestaImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Intestazione" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((it.latraccia.entity.sic.richiesta.impl.MessaggioRichiestaTypesImpl)it.latraccia.entity.sic.richiesta.impl.MessaggioRichiestaImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
