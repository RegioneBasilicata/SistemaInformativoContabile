    ...
    implements it.latraccia.entity.sic.risposta.MessaggioRisposta, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.MessaggioRisposta.class);
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.MessaggioRispostaImpl.Unmarshaller(context);
    }
...
+"q\u0000~\u0000 xq\u0000~\u0000\u001bt\u00002it.latraccia.entity.sic.risposta.IntestazioneT"
...
+"Schema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\fIntestazionet\u0000\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0000pp"
+"\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001c"
+"q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000.it.latraccia.entity.sic.risposta.SuccessoTypes"
+"q\u0000~\u0000#sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\bSuccessoq\u0000~"
+"\u0000>sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014p"
+"q\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000/it.latraccia.entity.sic.risposta.Ecc"
+"ezioneTypesq\u0000~\u0000#sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\t"
+"Eccezioneq\u0000~\u0000>sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0012Me"
+"ssaggio_Rispostaq\u0000~\u0000>sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000"
...
+"v/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0010\u0001pq\u0000~\u0000$q\u0000~\u0000Hq\u0000~\u0000Tq\u0000~\u0000Xq\u0000~\u0000\fq\u0000"
+"~\u0000Aq\u0000~\u0000Mq\u0000~\u0000\u0012q\u0000~\u0000Dq\u0000~\u0000Pq\u0000~\u0000\nq\u0000~\u0000\u000fq\u0000~\u0000Cq\u0000~\u0000Oq\u0000~\u0000?q\u0000~\u0000\tx"));
        }
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.MessaggioRispostaImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Intestazione" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((it.latraccia.entity.sic.risposta.impl.MessaggioRispostaTypesImpl)it.latraccia.entity.sic.risposta.impl.MessaggioRispostaImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
