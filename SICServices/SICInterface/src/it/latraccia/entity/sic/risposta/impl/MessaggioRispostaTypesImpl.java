...
public class MessaggioRispostaTypesImpl implements it.latraccia.entity.sic.risposta.MessaggioRispostaTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{

    protected it.latraccia.entity.sic.risposta.IntestazioneTypes _Intestazione;
    protected it.latraccia.entity.sic.risposta.SuccessoTypes _Successo;
    protected it.latraccia.entity.sic.risposta.EccezioneTypes _Eccezione;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.MessaggioRispostaTypes.class);
    }

    public it.latraccia.entity.sic.risposta.IntestazioneTypes getIntestazione() {
        return _Intestazione;
    }

    public void setIntestazione(it.latraccia.entity.sic.risposta.IntestazioneTypes value) {
        _Intestazione = value;
    }

    public it.latraccia.entity.sic.risposta.SuccessoTypes getSuccesso() {
        return _Successo;
    }

    public void setSuccesso(it.latraccia.entity.sic.risposta.SuccessoTypes value) {
        _Successo = value;
    }

    public it.latraccia.entity.sic.risposta.EccezioneTypes getEccezione() {
        return _Eccezione;
    }

    public void setEccezione(it.latraccia.entity.sic.risposta.EccezioneTypes value) {
        _Eccezione = value;
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.MessaggioRispostaTypesImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        if ((_Eccezione == null)&&(_Successo!= null)) {
...
+"calNamet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u00002it."
+"latraccia.entity.sic.risposta.IntestazioneTypest\u0000+http://jav"
+"a.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012psr\u0000\u001bcom"
...
+"~\u0000\u001csq\u0000~\u0000\u001dt\u0000\fIntestazionet\u0000\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006pp"
+"\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u000eq\u0000~\u0000\u0012psq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000.it."
+"latraccia.entity.sic.risposta.SuccessoTypesq\u0000~\u0000!sq\u0000~\u0000\fppsq\u0000~"
+"\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00007q\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\bSuccessoq\u0000~\u0000<sq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000"
+"ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u000eq\u0000~\u0000\u0012psq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq"
+"\u0000~\u0000\u001dt\u0000/it.latraccia.entity.sic.risposta.EccezioneTypesq\u0000~\u0000!s"
+"q\u0000~\u0000\fppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00007q\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\tEccezioneq\u0000~\u0000<sr\u0000"
...
+"\u0000~\u0000\rq\u0000~\u0000Aq\u0000~\u0000Mq\u0000~\u0000=x"));
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.MessaggioRispostaTypesImpl.this;
        }
                ...
                switch (state) {
                    case  4 :
                        if (("Risposta_InterrogazioneCapitoli" == ___local)&&("" == ___uri)) {
                            _Successo = ((it.latraccia.entity.sic.risposta.impl.SuccessoTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.SuccessoTypesImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  1 :
                        if (("InfoMittDest" == ___local)&&("" == ___uri)) {
                            _Intestazione = ((it.latraccia.entity.sic.risposta.impl.IntestazioneTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.IntestazioneTypesImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
                    ...
                    case  7 :
                        if (("Codice" == ___local)&&("" == ___uri)) {
                            _Eccezione = ((it.latraccia.entity.sic.risposta.impl.EccezioneTypesImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.EccezioneTypesImpl.class), 8, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
