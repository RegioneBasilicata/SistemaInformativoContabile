...
public class RispostaInterrogaCodiceSiopeTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogaCodiceSiopeTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogaCodiceSiopeTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getSiope() {
        if (_Siope == null) {
            _Siope = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Siope;
    }

    public java.util.List getSiope() {
        return _getSiope();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogaCodiceSiopeTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Siope == null)? 0 :_Siope.size());
        while (idx1 != len1) {
            context.startElement("", "Siope");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Siope.get(idx_0 ++)), "Siope");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Siope.get(idx_1 ++)), "Siope");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Siope.get(idx1 ++)), "Siope");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000Lit.latraccia.entity.sic.risposta.RispostaInterr"
+"ogaCodiceSiopeTypes.SiopeTypet\u0000+http://java.sun.com/jaxb/xjc"
...
+"ttp://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0005Siopet"
...
+"essionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000#q\u0000~\u0000\u0010q\u0000~\u0000\u0013q\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000\u0005x"));
    ...
    public static class SiopeTypeImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogaCodiceSiopeTypes.SiopeType, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
    {
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (it.latraccia.entity.sic.risposta.RispostaInterrogaCodiceSiopeTypes.SiopeType.class);
        }
        ...
        public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
            return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogaCodiceSiopeTypesImpl.SiopeTypeImpl.Unmarshaller(context);
        }
...
+"$\u0000\u0000\u0000\u0001q\u0000~\u0000!q\u0000~\u0000%\u0000\u0000\u0001\u00f4q\u0000~\u0000\'sq\u0000~\u0000(t\u0000\u000estring-derivedq\u0000~\u0000\u0018sq\u0000~\u0000+pp"
...
+"\u0000\u0005\u0001pq\u0000~\u0000,q\u0000~\u0000Iq\u0000~\u0000\nq\u0000~\u0000\u0005q\u0000~\u0000Cx"));
            ...
            extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return it.latraccia.entity.sic.risposta.impl.RispostaInterrogaCodiceSiopeTypesImpl.SiopeTypeImpl.this;
            }
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogaCodiceSiopeTypesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        if (("Codice" == ___local)&&("" == ___uri)) {
                            _getSiope().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogaCodiceSiopeTypesImpl.SiopeTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.RispostaInterrogaCodiceSiopeTypesImpl.SiopeTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
