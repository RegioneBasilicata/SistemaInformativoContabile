...
public class RispostaInterrogaReversaliCollegabiliTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogaReversaliCollegabiliTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogaReversaliCollegabiliTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getReversale() {
        if (_Reversale == null) {
            _Reversale = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Reversale;
    }

    public java.util.List getReversale() {
        return _getReversale();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogaReversaliCollegabiliTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Reversale == null)? 0 :_Reversale.size());
        while (idx1 != len1) {
            context.startElement("", "Reversale");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Reversale.get(idx_0 ++)), "Reversale");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Reversale.get(idx_1 ++)), "Reversale");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Reversale.get(idx1 ++)), "Reversale");
            context.endElement();
        }
    }
...
+"ogaReversaliCollegabiliTypes.ReversaleTypet\u0000+http://java.sun"
...
+"\u0000~\u0000\u001et\u0000\tReversalet\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPo"
...
+"\u0012q\u0000~\u0000\u0005x"));
    ...
    public static class ReversaleTypeImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogaReversaliCollegabiliTypes.ReversaleType, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
    {
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (it.latraccia.entity.sic.risposta.RispostaInterrogaReversaliCollegabiliTypes.ReversaleType.class);
        }
        ...
        public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
            return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogaReversaliCollegabiliTypesImpl.ReversaleTypeImpl.Unmarshaller(context);
        }
...
+"ilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u00000\u0001q\u0000~\u0000?sq\u0000~\u00009t\u0000\u0006Numeroq\u0000"
+"~\u0000\u0019sq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bppsr\u0000#com.sun.msv.datatype.xsd.Dou"
+"bleType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000+com.sun.msv.datatype.xsd.FloatingNumbe"
+"rType\u00fc\u00e3\u00b6\u0087\u008c\u00a8|\u00e0\u0002\u0000\u0000xq\u0000~\u0000\u001eq\u0000~\u0000!t\u0000\u0006doubleq\u0000~\u00007q\u0000~\u0000(sq\u0000~\u0000)q\u0000~\u0000Iq\u0000~"
+"\u0000!sq\u0000~\u0000,ppsq\u0000~\u0000.q\u0000~\u00001pq\u0000~\u00002q\u0000~\u0000;q\u0000~\u0000?sq\u0000~\u00009t\u0000\u0007Importoq\u0000~\u0000\u0019sr"
...
+"l;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000-q\u0000~\u0000Kq\u0000~\u0000\nq\u0000~\u0000\u0005q\u0000~\u0000Dx"));
            ...
            extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return it.latraccia.entity.sic.risposta.impl.RispostaInterrogaReversaliCollegabiliTypesImpl.ReversaleTypeImpl.this;
            }
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogaReversaliCollegabiliTypesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        if (("Numero" == ___local)&&("" == ___uri)) {
                            _getReversale().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogaReversaliCollegabiliTypesImpl.ReversaleTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.RispostaInterrogaReversaliCollegabiliTypesImpl.ReversaleTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                }
