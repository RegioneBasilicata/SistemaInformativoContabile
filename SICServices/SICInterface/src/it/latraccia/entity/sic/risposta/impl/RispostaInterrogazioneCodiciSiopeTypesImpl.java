...
public class RispostaInterrogazioneCodiciSiopeTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazioneCodiciSiopeTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _CodiceSiope;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogazioneCodiciSiopeTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getCodiceSiope() {
        if (_CodiceSiope == null) {
            _CodiceSiope = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _CodiceSiope;
    }

    public java.util.List getCodiceSiope() {
        return _getCodiceSiope();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneCodiciSiopeTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_CodiceSiope == null)? 0 :_CodiceSiope.size());
        while (idx1 != len1) {
            context.startElement("", "CodiceSiope");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _CodiceSiope.get(idx_0 ++)), "CodiceSiope");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _CodiceSiope.get(idx_1 ++)), "CodiceSiope");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _CodiceSiope.get(idx1 ++)), "CodiceSiope");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u00000it.latraccia.entity.sic.risposta.CodiceSiopeTyp"
...
+"ema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bCodiceSiopet\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv"
...
+"\u0000#q\u0000~\u0000\u0010q\u0000~\u0000\u0013q\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000\u0005x"));
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneCodiciSiopeTypesImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Codice" == ___local)&&("" == ___uri)) {
                            _getCodiceSiope().add(((it.latraccia.entity.sic.risposta.impl.CodiceSiopeTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.CodiceSiopeTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
