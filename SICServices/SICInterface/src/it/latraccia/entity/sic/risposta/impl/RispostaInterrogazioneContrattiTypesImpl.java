...
public class RispostaInterrogazioneContrattiTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazioneContrattiTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogazioneContrattiTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getContratto() {
        if (_Contratto == null) {
            _Contratto = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Contratto;
    }

    public java.util.List getContratto() {
        return _getContratto();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Contratto == null)? 0 :_Contratto.size());
        while (idx1 != len1) {
            context.startElement("", "Contratto");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Contratto.get(idx_0 ++)), "Contratto");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Contratto.get(idx_1 ++)), "Contratto");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Contratto.get(idx1 ++)), "Contratto");
            context.endElement();
        }
    }
...
+"ogazioneContrattiTypes.ContrattoTypet\u0000+http://java.sun.com/j"
...
+"\tContrattot\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
...
+"x"));
    ...
    public static class ContrattoTypeImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazioneContrattiTypes.ContrattoType, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
    {

        protected java.lang.String _NumeroRepertorio;
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (it.latraccia.entity.sic.risposta.RispostaInterrogazioneContrattiTypes.ContrattoType.class);
        }
        ...
        public void setNumeroRepertorio(java.lang.String value) {
        ...
        public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
            return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.Unmarshaller(context);
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            if (_NumeroRepertorio!= null) {
                context.startElement("", "NumeroRepertorio");
                context.endNamespaceDecls();
                context.endAttributes();
                try {
                    context.text(((java.lang.String) _NumeroRepertorio), "NumeroRepertorio");
                } catch (java.lang.Exception e) {
                    it.latraccia.entity.sic.risposta.impl.runtime.Util.handlePrintConversionException(this, e, context);
                }
                context.endElement();
...
+"\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u000f\u0001q\u0000~\u00006sq\u0000~\u00000t\u0000\u0006Chiavet\u0000\u0000q\u0000~\u00006sq\u0000~\u0000\tppsq\u0000~\u0000\u000b"
+"q\u0000~\u0000\u0010p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000\tppsq\u0000~\u0000\'q\u0000~\u0000\u0010pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u0000"
+"0t\u0000\u0010NumeroRepertorioq\u0000~\u0000:q\u0000~\u00006sq\u0000~\u0000\tppsq\u0000~\u0000\u000bq\u0000~\u0000\u0010p\u0000sq\u0000~\u0000\u0000ppq"
+"\u0000~\u0000\u0015sq\u0000~\u0000\tppsq\u0000~\u0000\'q\u0000~\u0000\u0010pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u000bDescrizioneq"
+"\u0000~\u0000:q\u0000~\u00006sq\u0000~\u0000\tppsq\u0000~\u0000\u000bq\u0000~\u0000\u0010p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000\tppsq\u0000~\u0000\'q\u0000~"
+"\u0000\u0010pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\tCodiceCupq\u0000~\u0000:q\u0000~\u00006sq\u0000~\u0000\tppsq\u0000~\u0000\u000b"
+"q\u0000~\u0000\u0010p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000\tppsq\u0000~\u0000\'q\u0000~\u0000\u0010pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u0000"
+"0t\u0000\tCodiceCigq\u0000~\u0000:q\u0000~\u00006sr\u0000\"com.sun.msv.grammar.ExpressionPoo"
...
+"msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0013\u0001pq\u0000~\u0000&q\u0000~\u0000>q\u0000~\u0000Eq\u0000~\u0000Lq\u0000~\u0000S"
+"q\u0000~\u0000\bq\u0000~\u0000\u0011q\u0000~\u0000=q\u0000~\u0000Dq\u0000~\u0000Kq\u0000~\u0000Rq\u0000~\u0000\nq\u0000~\u0000;q\u0000~\u0000Bq\u0000~\u0000Iq\u0000~\u0000Pq\u0000~\u0000\u0007"
+"q\u0000~\u0000\u0005q\u0000~\u0000\u0006x"));
            }
            return new com.sun.msv.verifier.regexp.REDocumentDeclaration(schemaFragment);
            ...
            extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.this;
            }
                ...
                throws org.xml.sax.SAXException
            {
                ...
                while (true) {
                    switch (state) {
                        case  3 :
                            if (("NumeroRepertorio" == ___local)&&("" == ___uri)) {
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (("Chiave" == ___local)&&("" == ___uri)) {
                            _getContratto().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("NumeroRepertorio" == ___local)&&("" == ___uri)) {
                            _getContratto().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _getContratto().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl) spawnChildFromLeaveElement((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
                        revertToParentFromLeaveElement(___uri, ___local, ___qname);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _getContratto().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl) spawnChildFromEnterAttribute((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
                        revertToParentFromEnterAttribute(___uri, ___local, ___qname);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _getContratto().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl) spawnChildFromLeaveAttribute((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
                        revertToParentFromLeaveAttribute(___uri, ___local, ___qname);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            _getContratto().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl) spawnChildFromText((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneContrattiTypesImpl.ContrattoTypeImpl.class), 2, value)));
                            return ;
                        case  3 :
                            revertToParentFromText(value);
                            return ;
