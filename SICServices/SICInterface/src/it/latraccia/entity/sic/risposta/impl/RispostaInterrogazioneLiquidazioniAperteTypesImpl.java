...
public class RispostaInterrogazioneLiquidazioniAperteTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazioneLiquidazioniAperteTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogazioneLiquidazioniAperteTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getLiquidazione() {
        if (_Liquidazione == null) {
            _Liquidazione = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Liquidazione;
    }

    public java.util.List getLiquidazione() {
        return _getLiquidazione();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneLiquidazioniAperteTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Liquidazione == null)? 0 :_Liquidazione.size());
        while (idx1 != len1) {
            context.startElement("", "Liquidazione");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Liquidazione.get(idx_0 ++)), "Liquidazione");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Liquidazione.get(idx_1 ++)), "Liquidazione");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Liquidazione.get(idx1 ++)), "Liquidazione");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000_it.latraccia.entity.sic.risposta.RispostaInterr"
+"ogazioneLiquidazioniAperteTypes.LiquidazioneTypet\u0000+http://ja"
+"va.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0014q\u0000~\u0000\npsr\u0000\u001bco"
...
+"\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\fLiquidazionet\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.Exp"
...
+"q\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000\u0005x"));
    ...
    public static class LiquidazioneTypeImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazioneLiquidazioniAperteTypes.LiquidazioneType, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
    {
        ...
        protected java.lang.String _Capitolo;
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (it.latraccia.entity.sic.risposta.RispostaInterrogazioneLiquidazioniAperteTypes.LiquidazioneType.class);
        }
        ...
        public void setCapitolo(java.lang.String value) {
            _Capitolo = value;
        }
        ...
        public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
            return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneLiquidazioniAperteTypesImpl.LiquidazioneTypeImpl.Unmarshaller(context);
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _Capitolo), "Capitolo");
            } catch (java.lang.Exception e) {
                it.latraccia.entity.sic.risposta.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"\u0000\u0007patternur\u0000\u0013[Ljava.lang.String;\u00ad\u00d2V\u00e7\u00e9\u001d{G\u0002\u0000\u0000xp\u0000\u0000\u0000\u0001t\u0000\b[0-9]{9}"
...
+"apse\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u001eq\u0000~\u0000+sq\u0000~\u0000,q\u0000~\u00008q\u0000~\u0000$sr\u0000#com.sun.msv.gr"
...
+"3\u0001q\u0000~\u0000Bsq\u0000~\u0000<t\u0000\u0006Numeroq\u0000~\u0000\u001csq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000eppsr\u0000\'com."
...
+"nLengthFacet\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001I\u0000\tminLengthxq\u0000~\u0000Jq\u0000~\u0000\u001cpq\u0000~\u0000\u001f\u0000\u0000q\u0000~\u0000#q"
+"\u0000~\u0000#t\u0000\tminLength\u0000\u0000\u0000\u0001q\u0000~\u0000#t\u0000\tmaxLength\u0000\u0000\u0000\u00f0q\u0000~\u0000+sq\u0000~\u0000,t\u0000\u000estrin"
+"g-derivedq\u0000~\u0000\u001csq\u0000~\u0000/ppsq\u0000~\u00001q\u0000~\u00004pq\u0000~\u00005q\u0000~\u0000>q\u0000~\u0000Bsq\u0000~\u0000<t\u0000\u0007Og"
+"gettoq\u0000~\u0000\u001csq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000eppsq\u0000~\u0000\u0012q\u0000~\u0000\u001cpq\u0000~\u0000\u001f\u0000\u0001sq\u0000~\u0000I"
+"q\u0000~\u0000\u001cpq\u0000~\u0000\u001f\u0000\u0001sq\u0000~\u0000Lq\u0000~\u0000\u001cpq\u0000~\u0000\u001f\u0000\u0000q\u0000~\u0000#q\u0000~\u0000#q\u0000~\u0000N\u0000\u0000\u0000\u0006q\u0000~\u0000#q\u0000~\u0000"
+"O\u0000\u0000\u0000\u0006q\u0000~\u0000#q\u0000~\u0000&uq\u0000~\u0000\'\u0000\u0000\u0000\u0001t\u0000\u0006U\\d{5}q\u0000~\u0000+sq\u0000~\u0000,t\u0000\u000estring-deriv"
+"edq\u0000~\u0000\u001csq\u0000~\u0000/ppsq\u0000~\u00001q\u0000~\u00004pq\u0000~\u00005q\u0000~\u0000>q\u0000~\u0000Bsq\u0000~\u0000<t\u0000\bCapitoloq"
+"\u0000~\u0000\u001csq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000eppsr\u0000#com.sun.msv.datatype.xsd.Do"
+"ubleType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000+com.sun.msv.datatype.xsd.FloatingNumb"
+"erType\u00fc\u00e3\u00b6\u0087\u008c\u00a8|\u00e0\u0002\u0000\u0000xq\u0000~\u0000!q\u0000~\u0000$t\u0000\u0006doubleq\u0000~\u0000:q\u0000~\u0000+sq\u0000~\u0000,q\u0000~\u0000jq\u0000"
+"~\u0000$sq\u0000~\u0000/ppsq\u0000~\u00001q\u0000~\u00004pq\u0000~\u00005q\u0000~\u0000>q\u0000~\u0000Bsq\u0000~\u0000<t\u0000\u0007Importoq\u0000~\u0000\u001cs"
+"q\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000fsq\u0000~\u0000/ppsq\u0000~\u00001q\u0000~\u00004pq\u0000~\u00005q\u0000~\u0000>q\u0000~\u0000Bsq\u0000~"
+"\u0000<t\u0000\u000eImportoResiduoq\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.ExpressionPo"
...
+"/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u000e\u0001pq\u0000~\u00000q\u0000~\u0000Rq\u0000~\u0000`q\u0000~\u0000lq\u0000~\u0000"
+"rq\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\u0007q\u0000~\u0000eq\u0000~\u0000qq\u0000~\u0000Gq\u0000~\u0000Wq\u0000~\u0000\u0006x"));
            }
            return new com.sun.msv.verifier.regexp.REDocumentDeclaration(schemaFragment);
        }
            ...
            extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneLiquidazioniAperteTypesImpl.LiquidazioneTypeImpl.this;
            }
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneLiquidazioniAperteTypesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (("Numero" == ___local)&&("" == ___uri)) {
                            _getLiquidazione().add(((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneLiquidazioniAperteTypesImpl.LiquidazioneTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneLiquidazioniAperteTypesImpl.LiquidazioneTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
