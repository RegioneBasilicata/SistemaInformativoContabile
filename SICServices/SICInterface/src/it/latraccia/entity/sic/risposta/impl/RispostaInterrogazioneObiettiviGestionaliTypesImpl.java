...
public class RispostaInterrogazioneObiettiviGestionaliTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazioneObiettiviGestionaliTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _ObiettivoGestionale;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogazioneObiettiviGestionaliTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getObiettivoGestionale() {
        if (_ObiettivoGestionale == null) {
            _ObiettivoGestionale = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _ObiettivoGestionale;
    }

    public java.util.List getObiettivoGestionale() {
        return _getObiettivoGestionale();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneObiettiviGestionaliTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_ObiettivoGestionale == null)? 0 :_ObiettivoGestionale.size());
        while (idx1 != len1) {
            context.startElement("", "ObiettivoGestionale");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ObiettivoGestionale.get(idx_0 ++)), "ObiettivoGestionale");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ObiettivoGestionale.get(idx_1 ++)), "ObiettivoGestionale");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ObiettivoGestionale.get(idx1 ++)), "ObiettivoGestionale");
            context.endElement();
        }
    }
...
+"anceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0013ObiettivoGestionalet\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv"
...
+"\u0000#q\u0000~\u0000\u0010q\u0000~\u0000\u0013q\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000\u0005x"));
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazioneObiettiviGestionaliTypesImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Codice" == ___local)&&("" == ___uri)) {
                            _getObiettivoGestionale().add(((it.latraccia.entity.sic.risposta.impl.COGTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.COGTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
