...
public class RispostaInterrogazionePCFTypesImpl implements it.latraccia.entity.sic.risposta.RispostaInterrogazionePCFTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaInterrogazionePCFTypes.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPianoDeiContiFina() {
        if (_PianoDeiContiFina == null) {
            _PianoDeiContiFina = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _PianoDeiContiFina;
    }

    public java.util.List getPianoDeiContiFina() {
        return _getPianoDeiContiFina();
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaInterrogazionePCFTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_PianoDeiContiFina == null)? 0 :_PianoDeiContiFina.size());
        while (idx1 != len1) {
            context.startElement("", "PianoDeiContiFina");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _PianoDeiContiFina.get(idx_0 ++)), "PianoDeiContiFina");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _PianoDeiContiFina.get(idx_1 ++)), "PianoDeiContiFina");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _PianoDeiContiFina.get(idx1 ++)), "PianoDeiContiFina");
            context.endElement();
        }
    }
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000(it.latraccia.entity.sic.risposta.PCFTypet\u0000+http"
...
+"anceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0011PianoDeiContiFinat\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.g"
...
+"q\u0000~\u0000\u0010q\u0000~\u0000\u0013q\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000\u0005x"));
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaInterrogazionePCFTypesImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Codice" == ___local)&&("" == ___uri)) {
                            _getPianoDeiContiFina().add(((it.latraccia.entity.sic.risposta.impl.PCFTypeImpl) spawnChildFromEnterElement((it.latraccia.entity.sic.risposta.impl.PCFTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
