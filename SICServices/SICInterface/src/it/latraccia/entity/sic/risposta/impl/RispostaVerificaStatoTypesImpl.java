...
public class RispostaVerificaStatoTypesImpl implements it.latraccia.entity.sic.risposta.RispostaVerificaStatoTypes, com.sun.xml.bind.JAXBObject, it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallableObject, it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializable, it.latraccia.entity.sic.risposta.impl.runtime.ValidatableObject
{

    protected java.lang.String _Attivo;
    protected java.lang.String _MotivoNonAttivo;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.latraccia.entity.sic.risposta.RispostaVerificaStatoTypes.class);
    }
    ...
    public void setAttivo(java.lang.String value) {
        _Attivo = value;
    }

    public java.lang.String getMotivoNonAttivo() {
        return _MotivoNonAttivo;
    }

    public void setMotivoNonAttivo(java.lang.String value) {
        _MotivoNonAttivo = value;
    }
    ...
    public it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingEventHandler createUnmarshaller(it.latraccia.entity.sic.risposta.impl.runtime.UnmarshallingContext context) {
        return new it.latraccia.entity.sic.risposta.impl.RispostaVerificaStatoTypesImpl.Unmarshaller(context);
    }

    public void serializeBody(it.latraccia.entity.sic.risposta.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "Attivo");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _Attivo), "Attivo");
        } catch (java.lang.Exception e) {
            it.latraccia.entity.sic.risposta.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        if (_MotivoNonAttivo!= null) {
            context.startElement("", "MotivoNonAttivo");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _MotivoNonAttivo), "MotivoNonAttivo");
            } catch (java.lang.Exception e) {
                it.latraccia.entity.sic.risposta.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000#\u0001q\u0000~\u00002sq\u0000~\u0000,t\u0000\u0006Atti"
+"vot\u0000\u0000sq\u0000~\u0000\u001fppsq\u0000~\u0000\u0006q\u0000~\u0000$p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u000esq\u0000~\u0000\u001fppsq\u0000~\u0000!q\u0000~\u0000$pq"
+"\u0000~\u0000%q\u0000~\u0000.q\u0000~\u00002sq\u0000~\u0000,t\u0000\u000fMotivoNonAttivoq\u0000~\u00006q\u0000~\u00002sr\u0000\"com.sun."
...
+"q\u0000~\u0000 q\u0000~\u0000:q\u0000~\u0000\nq\u0000~\u00009q\u0000~\u00007q\u0000~\u0000\u0005x"));
        ...
        extends it.latraccia.entity.sic.risposta.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.latraccia.entity.sic.risposta.impl.RispostaVerificaStatoTypesImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  3 :
                        if (("MotivoNonAttivo" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
